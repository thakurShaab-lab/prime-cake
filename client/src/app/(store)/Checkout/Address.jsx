...
import { addAddressAPI, saveTempAddressAPI, getTempAddressAPI } from "@/services/addressService"
  ...
  const handleSubmit = async () => {
    try {
      ...
      if (isLoggedIn) {
        ...
        await saveTempAddressAPI({
          ...form,
          address_type: "Ship"
        })
  
        addNotification("Address saved successfully ✅")
    ...
    <div className="pb-10">
      ...
      <div className="max-w-5xl mx-auto px-4 mt-6">
            ...
            <div className="bg-white p-4 rounded mt-3 text-sm">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div className="col-span-3">
                  ...
                  <input type="email" name="email" onChange={handleChange} className="border border-gray-300 rounded-lg p-2 w-full" />
                </div>
                <div>
                  <label className="block mb-1">First Name *</label>
                  <input type="text" name="first_name" onChange={handleChange} className="border border-gray-300 rounded-lg p-2 w-full" />
                </div>
                <div>
                  <label className="block mb-1">Last Name</label>
                  <input type="text" name="last_name" onChange={handleChange} className="border border-gray-300 rounded-lg p-2 w-full" />
                </div>
                <div>
                  <label className="block mb-1">Contact No. *</label>
                  <input type="text" name="mobile" onChange={handleChange} className="border border-gray-300 rounded-lg p-2 w-full" />
                </div>
                <div className="col-span-3">
                  <label className="block mb-1">Address *</label>
                  <input type="text" name="address" onChange={handleChange} className="border border-gray-300 rounded-lg p-2 w-full" />
                </div>
                <div>
        ...
        <div className="text-center mt-6">
          <button className="bg-[#b39e74] text-white px-6 py-2 rounded">
            View Order Summary
          </button>
        </div>
      </div>
