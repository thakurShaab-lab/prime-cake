...
export default function LoginPage() {
  ...
  const { loginUserHandler, loading } = useAuth()
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      // ✅ Redirect instantly (no timeout needed)
          ...
          <div className="max-w-md mx-auto bg-linear-to-t from-white via-[#efefef] to-[#f9f6f1] border-2 border-[#dddad3] rounded-2xl shadow-lg p-6">
            ...
            <div className="space-y-3">
              ...
              <button
                ...
                disabled={loading}
                className="w-full bg-black text-white py-2 rounded-md mt-4 hover:bg-gray-600 transition disabled:opacity-50"
              >
