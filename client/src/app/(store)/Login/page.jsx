                    ...
                    <div className="max-w-md mx-auto bg-linear-to-t from-white via-[#efefef] to-[#f9f6f1] border-2 border-[#dddad3] rounded-2xl shadow-lg p-6">
                        ...
                        <div className="space-y-3">
                            <div className="relative border border-[#a68849] shadow-lg rounded-lg">
                                ...
                                <input type="text" placeholder="Email ID *" className="w-full pl-10 pr-3 py-3 bg-transparent outline-none rounded-lg" />
                            </div>
                            <div className="relative border border-[#a68849] shadow-lg rounded-lg">
                                <span className="absolute left-3 top-1/2 -translate-y-1/2">
                                    <Image src="/password.svg" alt="password" width={20} height={20} />
                                </span>
                                <input type={showPassword ? "text" : "password"} placeholder="Password *" className="w-full pl-10 pr-3 py-3 bg-transparent outline-none rounded-lg" />
                            ...
                            <button onClick={() => (window.location.href = "/myaccount")} className="w-full bg-black text-white py-2 rounded-md mt-4 hover:bg-gray-600 transition">
                                Log In
                            </button>
                        </div>
